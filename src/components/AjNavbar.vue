<template>
    <div id="navbar" class="z-50 transition-all duration-700 bg-gray-100 background-pattern w-screen h-20 lg:h-60 fixed top-0 right-0 border-b-2 border-gray-200">
        <div class="hidden lg:block relative w-full h-24" style="font-family: 'times new roman';">
            ...
            <div id="logo-text" class="transition-all duration-700 select-none opacity-0 absolute transform translate-x-[-100%] left-0 top-0 ml-16 my-6">
                <h1 class="select-none text-5xl font-extrabold">AJ</h1>
            </div>
            <div id="logo" class="transition-all duration-700 absolute top-0 left-0 ml-16 mr-8 my-8 w-28 bg-gray-100">
