<template>
    <div class="space" :style="`
        ...
        `">
        <div class="transition-all duration-700 btn cursor-pointer relative h-14 bg-transparent hover:border-[1px] border-gray-900 hover:border-gray-900" :class="{ 'border-[1px] border-white': active }">
