<template>
    <div class="block lg:hidden fixed bottom-0 w-screen h-16 bg-gray-900">
        <div class="relative w-full h-full flex items-center justify-evenly">
            ...
            <a class="flex place-items-center" href="#">
                <img class="w-8" src="../assets/icons/popular.svg" alt="home">
            </a>
            <a class="flex place-items-center" href="#">
                <img class="w-8" src="../assets/icons/contact.svg" alt="home">
            </a>
            <a class="flex place-items-center" href="#">
                <img class="w-8" src="../assets/icons/about.svg" alt="home">
            </a>
        </div>
    </div>
</template>